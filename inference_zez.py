...
#######################################################
# exmaple of calling this function from bash

# python /home/zez/data2/pytorch_deeplab/pytorch-deeplab-xception/inference.py \
# ${work_root} ${work_root}/para.ini ${work_root}/list/test.txt \
# --backbone resnet --workers 1 --cuda --useBN --batchSize 1 \
# --resume ${work_root}/resnet_based_all_data_JI_Kanger_TSX_adeq_preLandsat_sentinel_0.007_Aug11.tar